...
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_SR_LOAD) |       \
                                     ...
                                     PIN_MODE_INPUT(GPIOB_ENC4_B) |         \
                                     PIN_MODE_OUTPUT(GPIOB_OLED_CS) |       \
                                     PIN_MODE_OUTPUT(GPIOB_OLED_DC) |       \
                                     PIN_MODE_INPUT(GPIOB_ENC2_A) |         \
                                     PIN_MODE_INPUT(GPIOB_ENC2_B) |         \
...
#define VAL_GPIOB_ODR               (PIN_ODR_LOW(GPIOB_SR_LOAD) |           \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_SR_LOAD, 0U) |       \
                                     ...
                                     PIN_AFIO_AF(GPIOB_ENC4_B, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_OLED_CS, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_OLED_DC, 0U) |       \
                                     PIN_AFIO_AF(GPIOB_ENC2_A, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_ENC2_B, 0U))
...
#define VAL_GPIOC_MODER             (PIN_MODE_ANALOG(GPIOC_POT4) |          \
                                     ...
                                     PIN_MODE_INPUT(GPIOC_ENC1_A) |         \
                                     PIN_MODE_INPUT(GPIOC_ENC1_B) |         \
...
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_POT4, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOC_ENC1_A, 0U) |        \
                                     PIN_AFIO_AF(GPIOC_ENC1_B, 0U))
...
#define VAL_GPIOD_MODER             (PIN_MODE_INPUT(GPIOD_PIN0) |           \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOD_LED_WS2812) |    \
...
#define VAL_GPIOD_AFRL              (PIN_AFIO_AF(GPIOD_PIN0, 0U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOD_LED_WS2812, 0U) |    \
 ...
 * PG11 - SR_DATA                   (output pushpull maximum).
...
#define VAL_GPIOG_PUPDR             (PIN_PUPDR_PULLUP(GPIOG_CART3_ID1) |    \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOG_SR_DATA) |    \
