...
/* Fixed-chain names. The numeric block remains stable until the legacy slot
 * UI and persistence users are removed by their dedicated passes. */
#define PARAM_MIDI_FX_GENERATOR_P1 PARAM_MIDI_FX_S1_PARAM1
#define PARAM_MIDI_FX_GENERATOR_P2 PARAM_MIDI_FX_S1_PARAM2
#define PARAM_MIDI_FX_GENERATOR_P3 PARAM_MIDI_FX_S1_PARAM3
#define PARAM_MIDI_FX_GENERATOR_P4 PARAM_MIDI_FX_S1_PARAM4
#define PARAM_MIDI_FX_VOICER_P1    PARAM_MIDI_FX_S1_MODEL
#define PARAM_MIDI_FX_VOICER_P2    PARAM_MIDI_FX_S2_PARAM1
#define PARAM_MIDI_FX_VOICER_P3    PARAM_MIDI_FX_S2_PARAM2
#define PARAM_MIDI_FX_VOICER_P4    PARAM_MIDI_FX_S2_PARAM3
#define PARAM_MIDI_FX_SCALER_P1    PARAM_MIDI_FX_S2_PARAM4
#define PARAM_MIDI_FX_SCALER_P2    PARAM_MIDI_FX_S2_MODEL
#define PARAM_MIDI_FX_SCALER_P3    PARAM_MIDI_FX_S3_PARAM1
#define PARAM_MIDI_FX_SCALER_P4    PARAM_MIDI_FX_S3_PARAM2
#define PARAM_MIDI_FX_TRIG_P1      PARAM_MIDI_FX_S3_PARAM3
#define PARAM_MIDI_FX_TRIG_P2      PARAM_MIDI_FX_S3_PARAM4
#define PARAM_MIDI_FX_TRIG_P3      PARAM_MIDI_FX_S3_MODEL
#define PARAM_MIDI_FX_TRIG_P4      PARAM_MIDI_FX_ORDER
