...
PARAM_ID_STATIC_ASSERT(PARAM_CFG_POLY_VOICES == 16, "Polyphony parameter IDs changed");
...
PARAM_ID_STATIC_ASSERT(PARAM_MIX_REVERB_DELAYS == 174, "Reverb parameter ID changed");
PARAM_ID_STATIC_ASSERT(PARAM_RESERVED_175 == 175, "Reserved parameter ID changed");
PARAM_ID_STATIC_ASSERT(PARAM_COUNT == 450, "Parameter count changed");
PARAM_ID_STATIC_ASSERT(PARAM_MIDI_FX_S1_PARAM1 == 291, "Persistent parameter count changed");
