...
void apply_lfo1_delay(float v);
void apply_lfo1_fade(float v);
void apply_lfo1_phase_slew(float v);
void apply_lfo1_rate(float v);
void apply_lfo1_shape(float v);
void apply_lfo1_trig(float v);
void apply_lfo2_delay(float v);
void apply_lfo2_fade(float v);
void apply_lfo2_phase_slew(float v);
