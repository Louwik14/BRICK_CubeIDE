...
void apply_mix_reverb_model(float v);
...
void apply_mix_reverb_smear(float v);
void apply_mix_reverb_digital_decay(float v);
void apply_mix_reverb_digital_damp(float v);
void apply_mix_reverb_digital_hpf(float v);
void apply_mix_reverb_digital_lpf(float v);
