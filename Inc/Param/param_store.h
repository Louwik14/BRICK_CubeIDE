...
PARAM_STORE_STATIC_ASSERT(PARAM_MIX_REVERB_DIGITAL_DECAY == 7, "Reverb parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MIX_REVERB_DIGITAL_DAMP == 8, "Reverb parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MIX_REVERB_DIGITAL_HPF == 9, "Reverb parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MIX_REVERB_DIGITAL_LPF == 10, "Reverb parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MIX_MUTE == 14, "Mute parameter ID changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MIX_REVERB_MODEL == 15, "Reverb parameter ID changed");
