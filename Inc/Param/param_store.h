...
enum {
    ...
    PARAM_SEQ_PLAY_V5_MICTIM,
    PARAM_SEQ_PLAY_V6_NOTE,
    PARAM_SEQ_PLAY_V6_VEL,
    PARAM_SEQ_PLAY_V6_LEN,
    PARAM_SEQ_PLAY_V6_MICTIM,
    PARAM_SEQ_PLAY_V7_NOTE,
    PARAM_SEQ_PLAY_V7_VEL,
    PARAM_SEQ_PLAY_V7_LEN,
    PARAM_SEQ_PLAY_V7_MICTIM,
    PARAM_SEQ_PLAY_V8_NOTE,
    PARAM_SEQ_PLAY_V8_VEL,
    PARAM_SEQ_PLAY_V8_LEN,
    PARAM_SEQ_PLAY_V8_MICTIM,

    PARAM_FM_DX7_OP1_PACK_A,
    PARAM_FM_DX7_OP1_PACK_B,
    PARAM_FM_DX7_OP1_PACK_C,
    PARAM_FM_DX7_OP1_PACK_D,
    PARAM_FM_DX7_OP2_PACK_A,
    PARAM_FM_DX7_OP2_PACK_B,
    PARAM_FM_DX7_OP2_PACK_C,
    PARAM_FM_DX7_OP2_PACK_D,
    PARAM_FM_DX7_OP3_PACK_A,
    PARAM_FM_DX7_OP3_PACK_B,
    PARAM_FM_DX7_OP3_PACK_C,
    PARAM_FM_DX7_OP3_PACK_D,
    PARAM_FM_DX7_OP4_PACK_A,
    PARAM_FM_DX7_OP4_PACK_B,
    PARAM_FM_DX7_OP4_PACK_C,
    PARAM_FM_DX7_OP4_PACK_D,
    PARAM_FM_DX7_OP5_PACK_A,
    PARAM_FM_DX7_OP5_PACK_B,
    PARAM_FM_DX7_OP5_PACK_C,
    PARAM_FM_DX7_OP5_PACK_D,
    PARAM_FM_DX7_OP6_PACK_A,
    PARAM_FM_DX7_OP6_PACK_B,
    PARAM_FM_DX7_OP6_PACK_C,
    PARAM_FM_DX7_OP6_PACK_D,
    PARAM_FM_DX7_PITCH_PACK_A,
    PARAM_FM_DX7_PITCH_PACK_B,
    PARAM_FM_DX7_PITCH_PACK_C,

    /* Public FM UI projections of the canonical DX7 base voice.  The
     * corresponding packed DX7 fields remain the persistence authority. */
    PARAM_FM_TRANSPOSE,
    PARAM_FM_PITCH_R1,
    PARAM_FM_PITCH_R2,
    PARAM_FM_PITCH_R3,
...
#define PARAM_MODFX_BANK_DELUGE_MONO_AB   PARAM_RESERVED_000
#define PARAM_MODFX_BANK_DELUGE_MONO_CD   PARAM_RESERVED_001
#define PARAM_MODFX_BANK_DELUGE_STEREO_AB PARAM_RESERVED_002
#define PARAM_MODFX_BANK_DELUGE_STEREO_CD PARAM_RESERVED_003
#define PARAM_MODFX_BANK_DAISY_AB         PARAM_RESERVED_004
#define PARAM_MODFX_BANK_DAISY_CD         PARAM_RESERVED_005
#define PARAM_MODFX_BANK_DIMENSION_AB     PARAM_RESERVED_006
#define PARAM_MODFX_BANK_DIMENSION_CD     PARAM_RESERVED_007
#define PARAM_MODFX_BANK_TEENSY_AB         PARAM_RESERVED_008
#define PARAM_MODFX_BANK_TEENSY_CD         PARAM_RESERVED_009
#define PARAM_MODFX_BANK_JUNOLOGUE_AB      PARAM_RESERVED_010
#define PARAM_MODFX_BANK_JUNOLOGUE_CD      PARAM_RESERVED_011
...
#define PARAM_FM_DX7_HIDDEN_FIRST     PARAM_FM_DX7_OP1_PACK_A
#define PARAM_FM_DX7_HIDDEN_LAST      PARAM_FM_DX7_PITCH_PACK_C
#define PARAM_FM_DX7_HIDDEN_COUNT     27U
...
PARAM_STORE_STATIC_ASSERT(PARAM_MIX_REVERB_DELAYS == 174, "Reverb parameter ID changed");
PARAM_STORE_STATIC_ASSERT(PARAM_RESERVED_175 == 175, "Reserved parameter ID changed");
PARAM_STORE_STATIC_ASSERT(PARAM_COUNT == 438, "Parameter count changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MIDI_FX_S1_PARAM1 == 293, "Persistent parameter count changed");
