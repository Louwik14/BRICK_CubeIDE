...
PARAM_STORE_STATIC_ASSERT(PARAM_COUNT == 316, "Parameter count changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MIDI_FX_S1_PARAM1 == 304, "Persistent parameter count changed");
