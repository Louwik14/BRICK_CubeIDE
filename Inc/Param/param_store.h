...
PARAM_STORE_STATIC_ASSERT(PARAM_COUNT == 309, "Parameter count changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MIDI_FX_S1_PARAM1 == 297, "Persistent parameter count changed");
