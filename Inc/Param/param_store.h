...
#if defined(BRICK6_STREAM_CALIBRATION) && BRICK6_STREAM_CALIBRATION
PARAM_STORE_STATIC_ASSERT(PARAM_COUNT == 429, "Calibration parameter count changed");
#else
PARAM_STORE_STATIC_ASSERT(PARAM_COUNT == 428, "Parameter count changed");
#endif
