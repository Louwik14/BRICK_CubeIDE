...
enum {
    ...
    PARAM_MACRO_FX1_TYPE,
    PARAM_MACRO_FX1_LEVEL,
    PARAM_MACRO_FX1_A,
    PARAM_MACRO_FX1_B,
    PARAM_MACRO_FX2_TYPE,
    PARAM_MACRO_FX2_LEVEL,
    PARAM_MACRO_FX2_A,
    PARAM_MACRO_FX2_B,
    PARAM_MACRO_FX3_TYPE,
    PARAM_MACRO_FX3_LEVEL,
    PARAM_MACRO_FX3_A,
    PARAM_MACRO_FX3_B,
    PARAM_MACRO_FX4_TYPE,
    PARAM_MACRO_FX4_LEVEL,
    PARAM_MACRO_FX4_A,
    PARAM_MACRO_FX4_B,
    PARAM_LOOPER_ARM,
    PARAM_LOOPER_LEN,
...
#endif
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX1_TYPE == 250, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX1_LEVEL == 251, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX1_A == 252, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX1_B == 253, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX2_TYPE == 254, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX2_LEVEL == 255, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX2_A == 256, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX2_B == 257, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX3_TYPE == 258, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX3_LEVEL == 259, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX3_A == 260, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX3_B == 261, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX4_TYPE == 262, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX4_LEVEL == 263, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX4_A == 264, "MacroFX parameter IDs changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MACRO_FX4_B == 265, "MacroFX parameter IDs changed");
