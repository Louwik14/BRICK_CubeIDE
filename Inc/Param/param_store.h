...
enum {
    ...
    PARAM_WAVE_OSC1_POS,
    PARAM_RESERVED_WAVE_XMOD_0,
    PARAM_RESERVED_WAVE_XMOD_1,
    PARAM_WAVE_OSC2_TABLE,
    PARAM_WAVE_OSC2_POS,
    PARAM_RESERVED_WAVE_XMOD_2,
    PARAM_RESERVED_WAVE_XMOD_3,
    PARAM_WAVE_VOLUME,
    PARAM_WAVE_BALANCE,
    PARAM_WAVE_TUNE,
    PARAM_WAVE_DETUNE,
...
#define PARAM_MODFX_BANK_DAISY_STEREO_AB  PARAM_RESERVED_006
#define PARAM_MODFX_BANK_DAISY_STEREO_CD  PARAM_RESERVED_007
#define PARAM_MODFX_BANK_DAISY_STEREO_EF  PARAM_RESERVED_008
#define PARAM_MODFX_BANK_DAISY_STEREO_G   PARAM_RESERVED_009
...
static inline uint8_t param_id_is_reserved(param_id_t id)
{
    switch (id)
    {
        ...
        case PARAM_RESERVED_WAVE_XMOD_0:
        case PARAM_RESERVED_WAVE_XMOD_1:
        case PARAM_RESERVED_WAVE_XMOD_2:
        case PARAM_RESERVED_WAVE_XMOD_3:
            return 1U;
        default:
            return 0U;
    }
...
PARAM_STORE_STATIC_ASSERT(PARAM_COUNT == 450, "Parameter count changed");
PARAM_STORE_STATIC_ASSERT(PARAM_MIDI_FX_S1_PARAM1 == 291, "Persistent parameter count changed");
