...
typedef enum
{
    ...
    UI_TRACK_TYPE_DX7, /* legacy type id retained for snapshot compatibility; no active routing */
    UI_TRACK_TYPE_MONOB, /* legacy type id retained for snapshot compatibility; no active routing */
