...
#define SEQ_PARAM_MIDI_FX_PARAM_COUNT  NOTE_FX_CHAIN_CANONICAL_PARAM_COUNT
...
#define SEQ_PARAM_MIDI_FX_PARAM_OFFSET (SEQ_PARAM_MOD_SLOT_OFFSET + SEQ_PARAM_MOD_SLOT_COUNT)
#define SEQ_PARAM_MIX_SLOT_OFFSET      (SEQ_PARAM_MIDI_FX_PARAM_OFFSET + SEQ_PARAM_MIDI_FX_PARAM_COUNT)
#define SEQ_PARAM_FM_OPERATOR_SLOT_OFFSET (SEQ_PARAM_MIX_SLOT_OFFSET + SEQ_PARAM_MIX_SLOT_COUNT)
#define SEQ_PARAM_AUDIO_FX_SLOT_OFFSET (SEQ_PARAM_FM_OPERATOR_SLOT_OFFSET + SEQ_PARAM_FM_OPERATOR_SLOT_COUNT)
#define SEQ_PARAM_RUNTIME_SLOT_COUNT   (SEQ_PARAM_AUDIO_FX_SLOT_OFFSET + SEQ_PARAM_AUDIO_FX_SLOT_COUNT)
