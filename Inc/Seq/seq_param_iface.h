...
_Static_assert(SEQ_PARAM_MIX_SLOT_OFFSET == 86U, "MIX p-lock offset changed");
_Static_assert(SEQ_PARAM_RUNTIME_SLOT_COUNT == 90U, "runtime p-lock slot count changed");
