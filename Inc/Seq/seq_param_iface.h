...
_Static_assert(SEQ_PARAM_MOD_SLOT_OFFSET == 46U, "MOD p-lock offset changed");
_Static_assert(SEQ_PARAM_MIDI_FX_SLOT_OFFSET == 58U, "MIDI FX p-lock offset changed");
_Static_assert(SEQ_PARAM_MIX_SLOT_OFFSET == 70U, "MIX p-lock offset changed");
_Static_assert(SEQ_PARAM_FM_OPERATOR_SLOT_OFFSET == 74U, "FM operator p-lock offset changed");
_Static_assert(SEQ_PARAM_RUNTIME_SLOT_COUNT == 140U, "runtime p-lock slot count changed");
...
_Static_assert(SEQ_PARAM_RUNTIME_FLAG_BYTE_COUNT == 280U, "runtime p-lock bitmap size changed");
