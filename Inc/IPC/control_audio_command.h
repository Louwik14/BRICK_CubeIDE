...
#define CONTROL_AUDIO_PARAM_KIND_SEQ_TEMP_TRACK          12U
#define CONTROL_AUDIO_PARAM_KIND_SEQ_CLEAR_TEMP_TRACK    13U
#define CONTROL_AUDIO_PARAM_KIND_SEQ_RESTORE_BASE_TRACK  14U
typedef enum
{
