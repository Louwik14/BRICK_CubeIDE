...
enum
{
    FX_REVERB_DRUMBOY_PREDELAY_BUFFER_SIZE = 4500U,
...
struct fx_reverb_drumboy_t {
    ...
    static const uint32_t kPredelayBufferSize = FX_REVERB_DRUMBOY_PREDELAY_BUFFER_SIZE;
    static const uint32_t kSurroundBufferSize = FX_REVERB_DRUMBOY_SURROUND_BUFFER_SIZE;
