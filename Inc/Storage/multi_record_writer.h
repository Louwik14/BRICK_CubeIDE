...
#define MULTI_RECORD_WRITER_RING_FRAMES 4096U
#endif
...
typedef enum
{
    ...
    MULTI_RECORD_WRITER_STATE_TEMP_READY,
    MULTI_RECORD_WRITER_STATE_COMMITTED,
    MULTI_RECORD_WRITER_STATE_DELETE_PENDING,
