...
typedef enum
{
    ...
    PERSIST_TYPE_RESERVED_LEGACY_DRUM_ANALOG_BD = 0x414E4244UL, /* ANBD */
...
typedef enum {
    PERSIST_INPUT_NONE = 0x4E4F4E45UL,
    PERSIST_INPUT_PHYSICAL_1 = 0x494E5031UL,
    PERSIST_INPUT_USB = 0x55534220UL
} persist_control_input_key_value_t;
