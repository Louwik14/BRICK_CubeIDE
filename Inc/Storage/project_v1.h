...
#define PROJECT_V1_FILE_VERSION    11U /* Dedicated PLAY step storage; older payloads are rejected. */
...
#define PROJECT_V1_SAMPLE_AUTOLOAD_SLOT_COUNT \
    (SAMPLE_POOL_SIZE + MULTI_SAMPLE_POOL_MAX_INSTRUMENTS + SAMPLER_RAM_POOL_MAX_SLOTS + WAVETABLE_POOL_MAX_SLOTS)
