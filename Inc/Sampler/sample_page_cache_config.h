...
#define BRICK6_PAGECACHE_PRESOCLE_PAGES       (512U)
#define BRICK6_PAGECACHE_ACTIVE_PAGES         (512U)
#define BRICK6_STREAM_ACTIVE_WINDOW_PAGES     (20U)
#define BRICK6_MULTI_PRESOCLE_PAGES           (8U)
#define BRICK6_MULTI_MAX_PREPARED_SAMPLES     (BRICK6_PAGECACHE_PRESOCLE_PAGES \
                                               / BRICK6_MULTI_PRESOCLE_PAGES)
#define BRICK6_STREAMER_RESERVE_MIN_PAGES     BRICK6_PAGECACHE_ACTIVE_PAGES
#define BRICK6_STREAMER_RESERVE_PRUDENT_PAGES BRICK6_PAGECACHE_ACTIVE_PAGES
...
#if ((BRICK6_PAGECACHE_PRESOCLE_PAGES + BRICK6_PAGECACHE_ACTIVE_PAGES) \
     != SAMPLE_PAGE_MAX_COUNT)
#error "PRESOCLE + ACTIVE pages must match SAMPLE_PAGE_MAX_COUNT"
#endif

#if (BRICK6_MULTI_PRESOCLE_PAGES == 0U)
#error "BRICK6_MULTI_PRESOCLE_PAGES must be non-zero"
#endif
