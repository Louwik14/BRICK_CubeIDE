...
#define SAMPLE_AUDIO_FORMAT_MIN_READY_FRAMES        (8192U)
#define SAMPLE_AUDIO_FORMAT_MONO_PRESOCLE_PAGES     (2U)
#define SAMPLE_AUDIO_FORMAT_STEREO_PRESOCLE_PAGES   (4U)
#define SAMPLE_AUDIO_FORMAT_MONO_WINDOW_PAGES       (2U)
#define SAMPLE_AUDIO_FORMAT_STEREO_WINDOW_PAGES     (4U)
