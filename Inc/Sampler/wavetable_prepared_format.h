...
#define WAVETABLE_PREPARED_FILE_VERSION     (2U)
#define WAVETABLE_PREPARED_HEADER_SIZE      (128U)
#define WAVETABLE_PREPARED_BAND_ENTRY_SIZE  (32U)
#define WAVETABLE_MIPMAP_DUPLICATE_SAMPLES  (7U)
#define WAVETABLE_MIPMAP_MAX_BANDS          (9U)
#define WAVETABLE_MIPMAP_PREP_REVISION      (3U)
