...
#define BOARD_ENCODER_TYPE_CONTINUOUS             0U
#define BOARD_ENCODER_TYPE_MECHANICAL_24_DETENTS  1U

#if defined(BRICK6_VARIANT_LOWCOST)
#ifndef LOWCOST_ENCODER_TYPE
#define LOWCOST_ENCODER_TYPE BOARD_ENCODER_TYPE_CONTINUOUS
#endif

#if (LOWCOST_ENCODER_TYPE == BOARD_ENCODER_TYPE_MECHANICAL_24_DETENTS)
#define BOARD_CONTROLS_ENCODER_TRANSITIONS_PER_INCREMENT 4U
#else
