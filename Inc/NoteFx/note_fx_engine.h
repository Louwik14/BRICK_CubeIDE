...
note_event_result_t note_fx_engine_source(const note_event_t *event, note_fx_emit_fn emit, void *context);
note_event_result_t note_fx_engine_stage_source(const note_event_t *event, uint8_t slot,
                                             note_fx_emit_fn emit, void *context);
