...
static inline uint32_t note_fx_walker_probe_elapsed(uint32_t started)
{
#if SEQ_FINE_DIAGNOSTICS
 return DWT->CYCCNT-started;
#else
 (void)started;return 0U;
#endif
}
...
#else
    (void)category;(void)started;(void)events_in;(void)events_out;
    (void)branches;(void)repeats;(void)held;(void)emissions;
#endif
}
