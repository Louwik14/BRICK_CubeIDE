...
typedef enum
{
    ...
    TRACK_RUNTIME_TYPE_ONE_SHOT = TRACK_RUNTIME_TYPE_SAMPLER,
    TRACK_RUNTIME_TYPE_RAM = TRACK_RUNTIME_TYPE_ONE_SHOT, /* product name for the legacy persisted OneShot value */
    TRACK_RUNTIME_TYPE_SLICER,
    TRACK_RUNTIME_TYPE_WAVE,
    TRACK_RUNTIME_TYPE_DRUM_TRX_BD,
    TRACK_RUNTIME_TYPE_MIDI,
    TRACK_RUNTIME_TYPE_CLIP,
    TRACK_RUNTIME_TYPE_STREAM = TRACK_RUNTIME_TYPE_CLIP, /* product name for the legacy persisted Clip value */
