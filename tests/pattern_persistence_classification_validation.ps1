...
$global = @(
    'PARAM_MIX_REVERB_SPECTRAL_POSITION', 'PARAM_MIX_REVERB_SPECTRAL_WIDTH',
    ...
    'PARAM_MIX_DELAY_FEEDBACK', 'PARAM_MIX_DELAY_SPECTRAL_POSITION', 'PARAM_MIX_DELAY_SPECTRAL_WIDTH',
