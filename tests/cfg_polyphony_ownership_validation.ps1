...
Require-Text $snapshotHeader 'float synth_spread;' 'Track snapshot does not carry SPREAD'
Require-Text $snapshot 'out_snapshot->synth_spread = synth_polyphony_get_spread(track);' 'Track snapshot does not capture SPREAD'
Require-Text $snapshot 'synth_polyphony_set_spread(target_track, snapshot->synth_spread);' 'Track snapshot does not restore SPREAD'
