...
'play_special_storage_validation=PASS save_load=yes special_action=yes notes_arp=excluded clipboard_roles=strict clear=yes undo_redo=yes formats=pattern/project-v5-kit/patch-v3'
