...
#define BRICK6_AUDIO_AC_DESC_SIZE        51U
#define BRICK6_AUDIO_AS_DESC_SIZE        52U
#define BRICK6_AUDIO_AS_COUNT            2U
#define BRICK6_AUDIO_TOTAL_DESC_SIZE     (BRICK6_AUDIO_IAD_DESC_SIZE + BRICK6_AUDIO_AC_DESC_SIZE + (BRICK6_AUDIO_AS_DESC_SIZE * BRICK6_AUDIO_AS_COUNT))
