...
#define USB_BRICK6_AUDIO_DESC_SIZE          91U
#define USB_BRICK6_COMPOSITE_CONFIG_DESC_SIZE \
  (USB_MIDI_CONFIG_DESC_SIZE + USB_BRICK6_AUDIO_DESC_SIZE)

#define USB_BRICK6_AUDIO_CONTROL_IF         0x01U
#define USB_BRICK6_AUDIO_STREAMING_IF       0x02U
#define USB_BRICK6_AUDIO_IN_EP              0x82U
#define USB_BRICK6_AUDIO_IN_EP_MAX_PACKET   0x0180U
...
__ALIGN_BEGIN uint8_t USBD_BRICK6_CfgDesc[USB_BRICK6_COMPOSITE_CONFIG_DESC_SIZE] __ALIGN_END =
{
  0x09,                       /* bLength: Configuration Descriptor size */
  USB_DESC_TYPE_CONFIGURATION,/* bDescriptorType: Configuration */
  LOBYTE(USB_BRICK6_COMPOSITE_CONFIG_DESC_SIZE),
  HIBYTE(USB_BRICK6_COMPOSITE_CONFIG_DESC_SIZE),
  0x03,                       /* bNumInterfaces: 3 interfaces (MIDI + Audio) */
  ...
  0x01,                   /* bNrInputPins: Number of Input Pins of this Jack. */
  MIDI_JACK_15,           /* BaSourceID(1): ID of the Entity to which this Input Pin is connected. */
  0x01,                   /* BaSourcePin(1): Output Pin number of the Entity to which this Input Pin is connected. */
  0x00,                   /* iJack: Unused. */
#endif
  ...
  USB_BRICK6_AUDIO_CONTROL_IF, /* bInterfaceNumber */
  ...
  USB_BRICK6_AUDIO_STREAMING_IF, /* baInterfaceNr(1) */
  ...
  0x09,                   /* bLength: Interface Descriptor size */
  USB_DESC_TYPE_INTERFACE,/* bDescriptorType: Interface */
  USB_BRICK6_AUDIO_STREAMING_IF, /* bInterfaceNumber */
  0x00,                   /* bAlternateSetting */
  0x00,                   /* bNumEndpoints */
  0x01,                   /* bInterfaceClass: AUDIO */
  ...
  0x02,                   /* bTerminalLink: Output Terminal ID */
  0x01,                   /* bDelay */
  ...
  USB_BRICK6_AUDIO_IN_EP, /* bEndpointAddress: IN endpoint 2 */
  0x05,                   /* bmAttributes: Isochronous, asynchronous */
  LOBYTE(USB_BRICK6_AUDIO_IN_EP_MAX_PACKET),
  HIBYTE(USB_BRICK6_AUDIO_IN_EP_MAX_PACKET),
...
{
  *length = sizeof(USBD_BRICK6_CfgDesc);
  return USBD_BRICK6_CfgDesc;
}
