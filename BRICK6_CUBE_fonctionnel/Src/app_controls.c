 ...
 * P0=room size, P1=wet, P2=drive sat, P3=mix sat */
static int16_t params[4] = {64, 64, 0, 127};
...
static void update_reverb_params(uint8_t smooth)
{
    ...
    float wet_target  = param_to_norm(params[1]);
...
void app_controls_render(void)
{
    ...
    snprintf(buf, sizeof(buf), "ROOM:%3d WET:%3d", (int)params[0], (int)params[1]);
