...
{
    static fx_reverb_drumboy_t instance;
    return &instance;
}
...
static inline float *comb_buffer_ptr(fx_reverb_drumboy_t *r, uint32_t idx)
{
    switch(idx)
    {
        case 0: return r->comb_buffer0;
        case 1: return r->comb_buffer1;
        case 2: return r->comb_buffer2;
        case 3: return r->comb_buffer3;
        case 4: return r->comb_buffer4;
        case 5: return r->comb_buffer5;
        case 6: return r->comb_buffer6;
        default: return r->comb_buffer7;
    }
}
...
static inline float *apass_buffer_ptr(fx_reverb_drumboy_t *r, uint32_t idx)
{
    switch(idx)
    {
        case 0: return r->apass_buffer0;
        case 1: return r->apass_buffer1;
        case 2: return r->apass_buffer2;
        default: return r->apass_buffer3;
    }
}
...
void fx_reverb_drumboy_reset(fx_reverb_drumboy_t *r)
{
    ...
    memset(r->predelay_buffer, 0, sizeof(r->predelay_buffer));
    memset(r->surround_buffer, 0, sizeof(r->surround_buffer));
    memset(r->comb_index, 0, sizeof(r->comb_index));
    memset(r->comb_filter, 0, sizeof(r->comb_filter));
    memset(r->comb_buffer0, 0, sizeof(r->comb_buffer0));
    memset(r->comb_buffer1, 0, sizeof(r->comb_buffer1));
    memset(r->comb_buffer2, 0, sizeof(r->comb_buffer2));
    memset(r->comb_buffer3, 0, sizeof(r->comb_buffer3));
    memset(r->comb_buffer4, 0, sizeof(r->comb_buffer4));
    memset(r->comb_buffer5, 0, sizeof(r->comb_buffer5));
    memset(r->comb_buffer6, 0, sizeof(r->comb_buffer6));
    memset(r->comb_buffer7, 0, sizeof(r->comb_buffer7));
    memset(r->apass_index, 0, sizeof(r->apass_index));
    memset(r->apass_buffer0, 0, sizeof(r->apass_buffer0));
    memset(r->apass_buffer1, 0, sizeof(r->apass_buffer1));
    memset(r->apass_buffer2, 0, sizeof(r->apass_buffer2));
    memset(r->apass_buffer3, 0, sizeof(r->apass_buffer3));
                                     ...
                                     uint32_t frames)
{
    ...
    for(uint32_t n = 0U; n < frames; ++n)
    {
        ...
        r->predelay_buffer[r->predelay_write] = input;
        const float reverb_input = r->predelay_buffer[r->predelay_play];
        ...
        r->surround_buffer[r->surround_write] = wet;
        const float delayed_r = r->surround_buffer[r->surround_play];
