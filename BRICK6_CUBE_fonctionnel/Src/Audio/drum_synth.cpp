...
uint8_t drum_synth_set_param_for_instance(uint8_t instance_id, param_id_t param, float value)
{
    ...
    switch ((drum_model_id_t)instance->active_type)
    {
        case DRUM_MODEL_ID_TRX_BD:
            switch (param)
            {
                case PARAM_DRUM_TRX_BD_PITCH: return drum_synth_set_serialized_param(instance->active_model, 0U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
        ...
        case DRUM_MODEL_ID_TRX_CLAVES:
            switch (param)
            {
                case PARAM_DRUM_TRX_CLAVES_PITCH: return drum_synth_set_serialized_param(instance->active_model, 0U, 5U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_TRX_CLAVES_INTERVAL: return drum_synth_set_serialized_param(instance->active_model, 1U, 5U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
        ...
        case DRUM_MODEL_ID_TRX_HIHAT:
            switch (param)
            {
                ...
                case PARAM_DRUM_TRX_HIHAT_LP_TONE: return drum_synth_set_serialized_param(instance->active_model, 2U, 6U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_TRX_HIHAT_HP_TONE: return drum_synth_set_serialized_param(instance->active_model, 3U, 6U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
        ...
        case DRUM_MODEL_ID_TRX_SNARE:
            switch (param)
            {
                case PARAM_DRUM_TRX_SNARE_PITCH: return drum_synth_set_serialized_param(instance->active_model, 0U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                ...
                case PARAM_DRUM_TRX_SNARE_TUNE_INTERVAL: return drum_synth_set_serialized_param(instance->active_model, 5U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
        ...
        case DRUM_MODEL_ID_FM_KICK:
            switch (param)
            {
                case PARAM_DRUM_FM_KICK_PITCH: return drum_synth_set_serialized_param(instance->active_model, 0U, 11U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
        ...
        case DRUM_MODEL_ID_FM_SNARE:
            switch (param)
            {
                case PARAM_DRUM_FM_SNARE_PITCH: return drum_synth_set_serialized_param(instance->active_model, 0U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
        ...
        case DRUM_MODEL_ID_FM_TOM:
            switch (param)
            {
                case PARAM_DRUM_FM_TOM_PITCH: return drum_synth_set_serialized_param(instance->active_model, 0U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_TOM_DECAY: return drum_synth_set_serialized_param(instance->active_model, 1U, 8U, value);
                case PARAM_DRUM_FM_TOM_MOD_FREQ: return drum_synth_set_serialized_param(instance->active_model, 2U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_TOM_FM_AMOUNT: return drum_synth_set_serialized_param(instance->active_model, 3U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
        ...
        case DRUM_MODEL_ID_FM_RIMSHOT:
            switch (param)
            {
                case PARAM_DRUM_FM_RIMSHOT_RIM_PITCH: return drum_synth_set_serialized_param(instance->active_model, 0U, 9U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_RIMSHOT_RIM_DECAY: return drum_synth_set_serialized_param(instance->active_model, 1U, 9U, value);
                case PARAM_DRUM_FM_RIMSHOT_RIM_FM_AMOUNT: return drum_synth_set_serialized_param(instance->active_model, 2U, 9U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_RIMSHOT_BODY_PITCH: return drum_synth_set_serialized_param(instance->active_model, 3U, 9U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_RIMSHOT_BODY_DECAY: return drum_synth_set_serialized_param(instance->active_model, 4U, 9U, value);
                case PARAM_DRUM_FM_RIMSHOT_BODY_FM_AMOUNT: return drum_synth_set_serialized_param(instance->active_model, 5U, 9U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                ...
                case PARAM_DRUM_FM_RIMSHOT_HP_TONE: return drum_synth_set_serialized_param(instance->active_model, 8U, 9U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                default: return 0U;
            }
        case DRUM_MODEL_ID_FM_CLAP:
            switch (param)
            {
                case PARAM_DRUM_FM_CLAP_BASE_FREQ: return drum_synth_set_serialized_param(instance->active_model, 0U, 10U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_CLAP_MOD_FREQ: return drum_synth_set_serialized_param(instance->active_model, 1U, 10U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_CLAP_FM_AMOUNT: return drum_synth_set_serialized_param(instance->active_model, 2U, 10U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                ...
                case PARAM_DRUM_FM_CLAP_CLAP_SPACING: return drum_synth_set_serialized_param(instance->active_model, 7U, 10U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_CLAP_HP_TONE: return drum_synth_set_serialized_param(instance->active_model, 8U, 10U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
        ...
        case DRUM_MODEL_ID_FM_COWBELL:
            switch (param)
            {
                case PARAM_DRUM_FM_COWBELL_PITCH: return drum_synth_set_serialized_param(instance->active_model, 0U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_COWBELL_DECAY_SHORT: return drum_synth_set_serialized_param(instance->active_model, 1U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_COWBELL_DECAY_LONG: return drum_synth_set_serialized_param(instance->active_model, 2U, 8U, value);
                case PARAM_DRUM_FM_COWBELL_MOD_FREQ: return drum_synth_set_serialized_param(instance->active_model, 3U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                case PARAM_DRUM_FM_COWBELL_FM_AMOUNT: return drum_synth_set_serialized_param(instance->active_model, 4U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
        ...
        case DRUM_MODEL_ID_FM_CYMBAL:
            switch (param)
            {
                ...
                case PARAM_DRUM_FM_CYMBAL_FM_AMOUNT: return drum_synth_set_serialized_param(instance->active_model, 3U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                ...
                case PARAM_DRUM_FM_CYMBAL_HP_TONE: return drum_synth_set_serialized_param(instance->active_model, 7U, 8U, drum_synth_map_ui_to_dsp(param, value, instance->note_pitch_factor));
                default: return 0U;
            }
        default:
            return 0U;
