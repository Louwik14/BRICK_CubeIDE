...
const param_desc_t param_registry[PARAM_COUNT] = {
    ...
    PARAM_DESC_EX(PARAM_DRUM_TRX_BD_PITCH, "Pitch", PARAM_TYPE_FLOAT, 20.0f, 120.0f, 0.1f, 50.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_TRX_CLAVES_PITCH, "Pitch", PARAM_TYPE_FLOAT, 200.0f, 4000.0f, 1.0f, 600.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_TRX_CLAVES_INTERVAL, "Intvl", PARAM_TYPE_FLOAT, 0.0f, 400.0f, 1.0f, 200.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_TRX_HIHAT_HP_TONE, "HP", PARAM_TYPE_FLOAT, 100.0f, 10000.0f, 1.0f, 4000.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_TRX_HIHAT_LP_TONE, "LP", PARAM_TYPE_FLOAT, 1000.0f, 12000.0f, 1.0f, 8000.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_TRX_SNARE_PITCH, "Pitch", PARAM_TYPE_FLOAT, 60.0f, 400.0f, 1.0f, 180.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_TRX_SNARE_TUNE_INTERVAL, "Tune", PARAM_TYPE_FLOAT, 0.0f, 400.0f, 1.0f, 100.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_TRX_SNARE_BUMP, "Bump", PARAM_TYPE_FLOAT, 0.0f, 1.0f, 0.01f, 0.1f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_KICK_PITCH, "Pitch", PARAM_TYPE_FLOAT, 20.0f, 100.0f, 1.0f, 50.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_FM_KICK_PITCH_SWEEP, "Sweep", PARAM_TYPE_FLOAT, 0.0f, 1000.0f, 0.1f, 60.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_KICK_FEEDBACK, "Fdbk", PARAM_TYPE_FLOAT, 0.0f, 16.0f, 0.01f, 0.5f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_KICK_MOD_FREQ, "ModFr", PARAM_TYPE_FLOAT, 50.0f, 2000.0f, 1.0f, 180.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_KICK_MOD_DECAY, "M Dec", PARAM_TYPE_FLOAT, 0.001f, 2.0f, 0.001f, 0.15f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_KICK_SWEEP_DECAY, "S Dec", PARAM_TYPE_FLOAT, 0.001f, 2.0f, 0.001f, 0.1f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_FM_SNARE_PITCH, "Pitch", PARAM_TYPE_FLOAT, 100.0f, 400.0f, 1.0f, 200.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_SNARE_DECAY, "Decay", PARAM_TYPE_FLOAT, 0.01f, 1.0f, 0.01f, 0.4f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_SNARE_FM_AMOUNT, "FM Amt", PARAM_TYPE_FLOAT, 0.0f, 50.0f, 0.01f, 15.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_SNARE_NOISE, "Noise", PARAM_TYPE_FLOAT, 0.0f, 1.0f, 0.01f, 0.5f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_SNARE_HP_TONE, "HP", PARAM_TYPE_FLOAT, 20.0f, 2000.0f, 1.0f, 400.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_SNARE_MOD_FREQ, "ModFr", PARAM_TYPE_FLOAT, 500.0f, 3000.0f, 1.0f, 1500.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_FM_TOM_PITCH, "Pitch", PARAM_TYPE_FLOAT, 80.0f, 400.0f, 1.0f, 150.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_TOM_DECAY, "Decay", PARAM_TYPE_FLOAT, 0.01f, 2.0f, 0.01f, 0.7f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_TOM_PITCH_SWEEP, "Sweep", PARAM_TYPE_FLOAT, 0.0f, 100.0f, 0.1f, 30.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_TOM_FM_AMOUNT, "FM Amt", PARAM_TYPE_FLOAT, 0.0f, 50.0f, 0.01f, 15.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_TOM_MOD_FREQ, "ModFr", PARAM_TYPE_FLOAT, 100.0f, 2000.0f, 1.0f, 300.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_FM_TOM_START_PHASE, "Phase", PARAM_TYPE_FLOAT, 0.0f, 3.14159f, 0.01f, 1.57f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_RIMSHOT_RIM_PITCH, "R Pitch", PARAM_TYPE_FLOAT, 200.0f, 1000.0f, 1.0f, 600.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_FM_RIMSHOT_HP_TONE, "HP", PARAM_TYPE_FLOAT, 100.0f, 2000.0f, 1.0f, 400.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_RIMSHOT_RIM_FM_AMOUNT, "R FM", PARAM_TYPE_FLOAT, 0.0f, 50.0f, 0.01f, 15.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_RIMSHOT_BODY_PITCH, "B Pitch", PARAM_TYPE_FLOAT, 80.0f, 400.0f, 1.0f, 200.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_FM_RIMSHOT_BODY_FM_AMOUNT, "B FM", PARAM_TYPE_FLOAT, 0.0f, 50.0f, 0.01f, 10.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_FM_CLAP_CLAP_SPACING, "Space", PARAM_TYPE_FLOAT, 0.005f, 0.05f, 0.001f, 0.012f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CLAP_TAIL_DECAY, "Tail", PARAM_TYPE_FLOAT, 0.01f, 0.9f, 0.01f, 0.3f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CLAP_HP_TONE, "HP", PARAM_TYPE_FLOAT, 20.0f, 2000.0f, 1.0f, 400.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CLAP_FEEDBACK, "Fdbk", PARAM_TYPE_FLOAT, 0.0f, 1.0f, 0.01f, 0.9f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CLAP_FM_AMOUNT, "FM Amt", PARAM_TYPE_FLOAT, 0.0f, 100.0f, 0.1f, 40.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CLAP_BASE_FREQ, "Base", PARAM_TYPE_FLOAT, 100.0f, 1200.0f, 1.0f, 800.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CLAP_MOD_FREQ, "ModFr", PARAM_TYPE_FLOAT, 100.0f, 3000.0f, 1.0f, 800.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_FM_COWBELL_PITCH, "Pitch", PARAM_TYPE_FLOAT, 200.0f, 1000.0f, 1.0f, 540.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_COWBELL_DECAY_SHORT, "D Shrt", PARAM_TYPE_FLOAT, 0.005f, 0.2f, 0.001f, 0.015f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_FM_COWBELL_FM_AMOUNT, "FM Amt", PARAM_TYPE_FLOAT, 0.0f, 100.0f, 0.1f, 15.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    ...
    PARAM_DESC_EX(PARAM_DRUM_FM_COWBELL_MOD_FREQ, "ModFr", PARAM_TYPE_FLOAT, 500.0f, 3000.0f, 1.0f, 2000.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CYMBAL_DECAY, "Decay", PARAM_TYPE_FLOAT, 0.05f, 4.0f, 0.01f, 1.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CYMBAL_SUSTAIN, "Sustain", PARAM_TYPE_FLOAT, 0.0f, 1.0f, 0.01f, 0.3f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CYMBAL_FM_AMOUNT, "FM Amt", PARAM_TYPE_FLOAT, 0.0f, 30.0f, 0.01f, 10.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CYMBAL_HP_TONE, "HP", PARAM_TYPE_FLOAT, 100.0f, 2000.0f, 1.0f, 300.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CYMBAL_FEEDBACK, "Fdbk", PARAM_TYPE_FLOAT, 0.0f, 1.0f, 0.01f, 0.5f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CYMBAL_BASE_CARRIER, "Carr", PARAM_TYPE_FLOAT, 100.0f, 1000.0f, 1.0f, 400.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_DRUM_FM_CYMBAL_BASE_MOD, "Mod", PARAM_TYPE_FLOAT, 200.0f, 2000.0f, 1.0f, 800.0f, PARAM_DISPLAY_FLOAT, "", NULL, NULL),
