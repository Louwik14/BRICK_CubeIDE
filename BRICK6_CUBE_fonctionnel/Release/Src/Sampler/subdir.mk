################################################################################
# Manually-added for Sampler sources (Phase 3)
################################################################################

C_SRCS += \
../Src/Sampler/sample_pool.c \
../Src/Sampler/voice_manager.c 

C_DEPS += \
./Src/Sampler/sample_pool.d \
./Src/Sampler/voice_manager.d 

OBJS += \
./Src/Sampler/sample_pool.o \
./Src/Sampler/voice_manager.o 

Src/Sampler/%.o Src/Sampler/%.su Src/Sampler/%.cyclo: ../Src/Sampler/%.c Src/Sampler/subdir.mk
...
clean: clean-Src-2f-Sampler

clean-Src-2f-Sampler:
	-$(RM) ./Src/Sampler/sample_pool.cyclo ./Src/Sampler/sample_pool.d ./Src/Sampler/sample_pool.o ./Src/Sampler/sample_pool.su ./Src/Sampler/voice_manager.cyclo ./Src/Sampler/voice_manager.d ./Src/Sampler/voice_manager.o ./Src/Sampler/voice_manager.su

.PHONY: clean-Src-2f-Sampler
