...
CC_SRCS += \
../mutable_instruments/peaks/processors.cc 

CC_DEPS += \
./mutable_instruments/peaks/processors.d 

OBJS += \
./mutable_instruments/peaks/processors.o 


# Each subdirectory must supply rules for building sources it contributes
mutable_instruments/peaks/%.o mutable_instruments/peaks/%.su mutable_instruments/peaks/%.cyclo: ../mutable_instruments/peaks/%.cc mutable_instruments/peaks/subdir.mk
...
clean: clean-mutable_instruments-2f-peaks

clean-mutable_instruments-2f-peaks:
	-$(RM) ./mutable_instruments/peaks/processors.cyclo ./mutable_instruments/peaks/processors.d ./mutable_instruments/peaks/processors.o ./mutable_instruments/peaks/processors.su

.PHONY: clean-mutable_instruments-2f-peaks
