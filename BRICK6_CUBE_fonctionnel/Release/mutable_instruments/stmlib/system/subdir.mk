...
CC_SRCS += \
../mutable_instruments/stmlib/system/bootloader_utils.cc \
../mutable_instruments/stmlib/system/system_clock.cc 

CC_DEPS += \
./mutable_instruments/stmlib/system/bootloader_utils.d \
./mutable_instruments/stmlib/system/system_clock.d 

OBJS += \
./mutable_instruments/stmlib/system/bootloader_utils.o \
./mutable_instruments/stmlib/system/system_clock.o 


# Each subdirectory must supply rules for building sources it contributes
mutable_instruments/stmlib/system/%.o mutable_instruments/stmlib/system/%.su mutable_instruments/stmlib/system/%.cyclo: ../mutable_instruments/stmlib/system/%.cc mutable_instruments/stmlib/system/subdir.mk
...
clean: clean-mutable_instruments-2f-stmlib-2f-system

clean-mutable_instruments-2f-stmlib-2f-system:
	-$(RM) ./mutable_instruments/stmlib/system/bootloader_utils.cyclo ./mutable_instruments/stmlib/system/bootloader_utils.d ./mutable_instruments/stmlib/system/bootloader_utils.o ./mutable_instruments/stmlib/system/bootloader_utils.su ./mutable_instruments/stmlib/system/system_clock.cyclo ./mutable_instruments/stmlib/system/system_clock.d ./mutable_instruments/stmlib/system/system_clock.o ./mutable_instruments/stmlib/system/system_clock.su

.PHONY: clean-mutable_instruments-2f-stmlib-2f-system
