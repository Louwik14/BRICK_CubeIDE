...
if ([string]::IsNullOrWhiteSpace($OutputRoot)) {
    $folderName = if ($Bank -eq "BoC") { "BRICK6_BoC_Inspired_Patches" } else { "BRICK6_Musical_Patches" }
    $OutputRoot = Join-Path $RepoRoot "artifacts\$folderName"
}
$OutputRoot = [System.IO.Path]::GetFullPath($OutputRoot)
$PatchDir = Join-Path $OutputRoot "BRICK\PATCH"
$zipName = if ($Bank -eq "BoC") {
    "BRICK6_BoC_Inspired_Patches_P128-P191.zip"
} else {
    "BRICK6_Musical_Patches_P064-P127.zip"
}
...
$generalRows = $rows
$bocRows = @'
SUN FADE|Keys|Stack|7,0,3|0.38,0.24,0.14|0.00,0.05,-12.00|0.42,0.34,0.62|0.38,0.46,0.32|0.50,0.56,0.50|72|14|28|Tape|0.06|0.02|Warm faded keyboard with restrained tape drift
DUST KEY|Keys|Prism|3,12|0.48,0.14|0.50,0.505|0.38,0.30|0.34,0.42|0.015,0.00|68|18|32|Faded|0.08|0.03|Dusty educational-film keyboard
COLD EDU|Keys|Deluge|1|0.68|0.00|0.50|0.00|-2.00|82|10|20|Stable|0.04|0.01|Plain cold triangle classroom synth
TAPE TINES|Keys|Prism|20,3|0.44,0.16|0.50,0.56|0.52,0.34|0.44,0.32|0.12,0.00|86|8|34|Tape|0.10|0.03|Soft FM tines recorded on aging tape
PALE COMBO|Organ|Stack|8,3,0|0.34,0.24,0.14|0.00,-12.00,12.00|0.34,0.64,0.42|0.32,0.38,0.46|0.50,0.50,0.52|76|12|14|Stable|0.05|0.01|Pale compact organ with quiet movement
FILM ORGAN|Organ|Deluge|3|0.66|0.00|0.42|0.00|-3.00|70|16|18|Tape|0.04|0.01|Muted analog-square documentary organ
SMALL CHOIR|Organ|Prism|17,12|0.42,0.18|0.50,0.505|0.50,0.32|0.52,0.38|0.01,0.00|78|14|20|Fragile|0.08|0.03|Small synthetic choir with human fragility
FADED STR|Strings|Stack|7,7,0|0.36,0.32,0.10|0.00,0.07,12.00|0.40,0.46,0.34|0.42,0.38,0.48|0.50,0.50,0.52|66|18|30|Faded|0.10|0.03|Faded mono string-machine voice
SCHOOL STR|Strings|Prism|14,3|0.38,0.20|0.50,0.505|0.32,0.46|0.38,0.34|0.01,0.00|74|12|26|Stable|0.07|0.02|Simple school-film string ensemble
HAZE STR|Strings|Deluge|5|0.62|0.00|0.56|0.00|2.00|70|10|24|Fragile|0.09|0.03|Hazy analog saw string line
WORN KEYS|Keys|Stack|12,1,3|0.40,0.20,0.12|0.00,12.00,-12.00|0.44,0.30,0.64|0.36,0.48,0.34|0.42,0.50,0.50|64|20|38|Tape|0.06|0.02|Worn morph keyboard with soft edges
GLASS EDU|Keys|Prism|23,12|0.38,0.14|0.50,0.62|0.56,0.34|0.58,0.42|0.07,0.00|94|8|24|Naive|0.10|0.04|Naive glass keyboard from an old science film
MOSS EP|Keys|Stack|0,4,3|0.42,0.18,0.12|0.00,12.00,-12.00|0.54,0.42,0.68|0.34,0.46,0.30|0.62,0.44,0.50|70|16|36|Faded|0.08|0.02|Mossy folded electric piano
CHILD KEY|Keys|Stack|1,8,3|0.42,0.18,0.12|0.00,12.00,-12.00|0.30,0.54,0.70|0.50,0.34,0.28|0.36,0.50,0.50|88|8|30|Naive|0.09|0.03|Innocent toy keyboard with a faint uneasy edge
PALE TAPE|Pad|Stack|11,12,0|0.42,0.30,0.08|0.00,0.04,12.00|0.38,0.54,0.30|0.34,0.42,0.52|0.50,0.58,0.52|62|18|28|Tape|0.12|0.04|Pale slow pad with subtle tape instability
OLD FILM|Pad|Prism|6,3|0.44,0.18|0.50,0.505|0.30,0.44|0.28,0.36|0.01,0.00|58|20|34|Faded|0.10|0.03|Dark warm pad for an old educational film
AMBER FOG|Pad|Deluge|5|0.62|0.00|0.54|0.00|2.00|68|12|26|Fragile|0.14|0.04|Amber analog fog with gentle motion
GREY SKY|Pad|Prism|14,12|0.36,0.20|0.50,0.505|0.34,0.30|0.46,0.38|0.01,0.00|72|10|22|Stable|0.12|0.04|Mostly stable grey swarm pad
WARM STATIC|Pad|Stack|9,0,3|0.34,0.24,0.12|0.00,12.00,-12.00|0.32,0.42,0.66|0.58,0.36,0.30|0.48,0.54,0.50|64|16|30|Faded|0.10|0.03|Warm static-like swarm without excess noise
FRAGILE AIR|Pad|Prism|17,23|0.36,0.12|0.50,0.62|0.46,0.56|0.54,0.62|0.02,0.05|84|8|18|Fragile|0.16|0.05|Fragile breath and distant bell air
COLD SUN|Pad|Deluge|1|0.64|0.00|0.50|180.00|1.00|76|8|20|Tape|0.12|0.04|Cold triangle pad with restrained pitch drift
MOSS VEIL|Pad|Stack|12,3,0|0.40,0.22,0.10|0.00,-12.00,12.00|0.50,0.68,0.32|0.34,0.30,0.48|0.44,0.50,0.54|60|22|36|Fragile|0.13|0.04|Soft moss-covered evolving veil
NIGHT EDU|Pad|Prism|16,3|0.42,0.16|0.50,0.505|0.56,0.38|0.30,0.42|0.02,0.00|64|24|30|Threat|0.10|0.03|Nasal night-school pad with quiet tension
SLEEP MAP|Pad|Stack|3,11,0|0.36,0.28,0.10|-12.00,0.00,12.00|0.68,0.38,0.34|0.30,0.42,0.50|0.50,0.48,0.52|56|14|26|Evolve|0.15|0.05|Very slow map-like ambient bed
SIMPLE ARC|Lead|Stack|7,3,0|0.42,0.22,0.08|0.00,-12.00,12.00|0.46,0.68,0.34|0.38,0.30,0.50|0.50,0.50,0.52|76|14|24|Stable|0.04|0.01|Simple memorable analog arc lead
EDU FLUTE|Lead|Prism|12,3|0.50,0.10|0.50,0.62|0.34,0.44|0.52,0.34|0.00,0.00|88|8|18|Flute|0.07|0.02|Synthetic classroom flute with delayed vibrato
SUN NEEDLE|Lead|Deluge|5|0.68|0.00|0.52|0.00|1.00|82|12|20|Flute|0.05|0.01|Thin warm analog needle melody
NASAL STAR|Lead|Stack|1,8,3|0.40,0.20,0.10|0.00,12.00,-12.00|0.62,0.46,0.68|0.34,0.42,0.28|0.38,0.50,0.50|72|22|30|Threat|0.04|0.01|Nasal star-like lead with mild unease
MEMORY LINE|Lead|Prism|3,16|0.46,0.14|0.50,0.505|0.42,0.56|0.36,0.30|0.01,0.00|78|16|24|Tape|0.05|0.02|Faded memorable mono melody voice
PALE WHISTLE|Lead|Prism|12,23|0.50,0.08|0.50,0.69|0.28,0.52|0.48,0.58|0.00,0.03|96|6|16|Flute|0.08|0.03|Pale synthetic whistle with bell breath
EMPTY ROAD|Lead|Deluge|1|0.70|0.00|0.50|0.00|-1.00|70|10|20|Stable|0.03|0.01|Lonely plain triangle roadside lead
TINY SIGNAL|Lead|Stack|0,6,3|0.44,0.16,0.08|0.00,12.00,-12.00|0.52,0.42,0.70|0.36,0.54,0.26|0.60,0.44,0.50|84|12|28|Naive|0.04|0.01|Childlike signal tone with subtle wrongness
MOSS BASS|Bass|Stack|3,0,0|0.58,0.18,0.00|-12.00,0.00,0.00|0.70,0.38,0.50|0.30,0.42,0.50|0.50,0.54,0.50|48|12|30|Stable|0.01|0.00|Round dark moss-covered sub bass
ROUND FLOOR|Bass|Deluge|0|0.78|-12.00|0.50|0.00|0.00|50|6|18|Stable|0.00|0.00|Clean round floor-shaking sine bass
ACID LESSON|Bass|Prism|8,6|0.48,0.16|0.38,0.385|0.62,0.34|0.42,0.30|0.04,0.00|54|58|68|Acid|0.02|0.02|Muted acid lesson with controlled resonance
TAPE REESE|Bass|Stack|7,7,3|0.42,0.38,0.12|-12.00,-11.94,-24.00|0.42,0.48,0.72|0.46,0.40,0.28|0.50,0.50,0.50|56|18|28|Tape|0.02|0.00|Subtle beating Reese recorded to tape
COLD PULSE|Bass|Deluge|3|0.74|-12.00|0.38|0.00|-3.00|52|18|30|Threat|0.01|0.00|Cold analog-square pulse bass
DULL ROOT|Bass|Prism|6,12|0.50,0.14|0.38,0.385|0.36,0.28|0.28,0.34|0.01,0.00|46|16|32|Faded|0.01|0.00|Dull sub-root bass with faded harmonics
DARK SAW|Bass|Deluge|5|0.72|-12.00|0.46|0.00|1.00|54|14|26|Tape|0.01|0.00|Dark analog saw bass with slow wear
LOW THREAT|Bass|Stack|5,3,6|0.38,0.30,0.10|-12.00,-24.00,0.00|0.54,0.72,0.40|0.46,0.28,0.52|0.58,0.50,0.42|58|26|38|Threat|0.01|0.00|Low feedback threat anchored by a sub
TOY PEG|Pluck|Stack|1,3,0|0.44,0.20,0.00|0.00,-12.00,0.00|0.26,0.64,0.50|0.48,0.30,0.50|0.34,0.50,0.50|66|10|46|Naive|0.03|0.01|Dry naive toy peg
DUST PLUCK|Pluck|Prism|12,6|0.48,0.12|0.50,0.505|0.32,0.26|0.36,0.28|0.00,0.00|62|14|52|Faded|0.04|0.01|Dusty soft pizzicato pluck
SOFT CLICK|Pluck|Deluge|1|0.68|0.00|0.50|0.00|-1.00|68|6|38|Stable|0.02|0.00|Soft innocent triangle click
TINY DROP|Pluck|Prism|20,3|0.44,0.10|0.50,0.62|0.58,0.34|0.48,0.32|0.16,0.00|92|8|48|Naive|0.06|0.02|Tiny FM droplet for childlike motifs
WOOD FRAME|Pluck|Stack|0,3,0|0.42,0.18,0.00|0.00,-12.00,0.00|0.44,0.68,0.50|0.30,0.28,0.50|0.58,0.50,0.50|58|12|44|Faded|0.03|0.01|Muted wooden-frame pluck
OLD REED|Pluck|Prism|16,12|0.46,0.12|0.50,0.57|0.48,0.30|0.28,0.38|0.01,0.00|72|18|50|Tape|0.04|0.01|Short old reed pluck with tape wear
SCHOOL BELL|Bell|Stack|0,6,3|0.40,0.16,0.10|0.00,12.00,-12.00|0.58,0.42,0.70|0.38,0.56,0.26|0.62,0.42,0.50|94|10|20|Naive|0.12|0.04|Small school bell with softened edges
PALE MALLET|Bell|Prism|23,12|0.40,0.12|0.50,0.69|0.56,0.30|0.60,0.38|0.07,0.00|98|8|18|Faded|0.12|0.04|Pale mallet from an old classroom recording
FILM GLOCK|Bell|Prism|12,23|0.42,0.10|0.50,0.74|0.34,0.62|0.46,0.66|0.00,0.06|106|6|14|Tape|0.14|0.05|Faded documentary glockenspiel
WOOD CHIME|Bell|Stack|1,3,0|0.42,0.18,0.00|0.00,-12.00,0.00|0.24,0.62,0.50|0.26,0.34,0.50|0.32,0.50,0.50|72|14|34|Stable|0.08|0.02|Warm compact wooden chime
TAPE BOWL|Bell|Prism|13,23|0.38,0.16|0.50,0.62|0.44,0.58|0.52,0.62|0.02,0.07|82|22|20|Tape|0.16|0.05|Dark tape-aged bowl resonance
CHILD CHIME|Bell|Prism|15,23|0.40,0.10|0.50,0.69|0.50,0.64|0.58,0.68|0.02,0.05|102|8|16|Naive|0.14|0.04|Sweet toy chime that turns faintly uncanny
TAPE ROOM|Texture|Stack|9,3,0|0.30,0.24,0.10|-12.00,0.00,12.00|0.34,0.70,0.32|0.56,0.28,0.48|0.48,0.50,0.54|52|18|24|Tape|0.14|0.05|Slow empty tape-room atmosphere
OLD WEATHER|Texture|Prism|35,32|0.34,0.14|0.50,0.505|0.46,0.38|0.48,0.56|0.03,0.00|60|16|22|Dust|0.16|0.05|Aged weather-film cloud texture
EDU HUM|Texture|Deluge|1|0.58|-12.00|0.50|90.00|1.00|48|12|20|Faded|0.10|0.03|Low educational projector-like hum
GREEN DRONE|Texture|Stack|3,12,0|0.38,0.28,0.12|-24.00,-12.00,0.00|0.70,0.48,0.34|0.28,0.42,0.52|0.50,0.60,0.54|46|20|28|Evolve|0.15|0.05|Deep green slow-moving drone
DUST CLOUD|Texture|Prism|36,17|0.32,0.18|0.50,0.505|0.54,0.48|0.62,0.50|0.04,0.01|68|14|20|Dust|0.18|0.06|Irregular spectral dust cloud
COLD MOTOR|Texture|Deluge|3|0.58|-12.00|0.26|270.00|-5.00|50|26|30|Threat|0.10|0.03|Cold slow motor pulse for an old soundtrack
SLOW MACHINE|Texture|Stack|8,6,3|0.30,0.22,0.14|-12.00,0.00,-24.00|0.48,0.44,0.72|0.34,0.56,0.26|0.50,0.44,0.50|54|22|30|Faded|0.12|0.04|Slow mechanical square and ring texture
MOSS SIGNAL|Texture|Stack|11,1,3|0.34,0.22,0.12|-12.00,0.00,-24.00|0.56,0.30,0.70|0.32,0.52,0.26|0.66,0.38,0.50|58|18|26|Fragile|0.14|0.05|Fragile mossy signal drone
BENT LESSON|Experimental|Stack|12,6,3|0.34,0.24,0.12|0.00,7.00,-12.00|0.54,0.42,0.70|0.34,0.58,0.26|0.64,0.44,0.50|70|24|34|Unstable|0.08|0.03|Bent but playable educational motif voice
BROKEN TOY|Experimental|Prism|15,22|0.38,0.16|0.50,0.57|0.58,0.62|0.66,0.48|0.04,0.08|86|18|26|Unstable|0.10|0.04|Broken digital toy that remains melodic
LOST NUMBER|Experimental|Deluge|2|0.62|0.00|0.34|135.00|5.00|72|20|28|Unstable|0.08|0.03|Unsteady square counting tone
SMALL PANIC|Experimental|Stack|5,11,3|0.34,0.24,0.12|-12.00,0.00,-24.00|0.62,0.54,0.72|0.48,0.34,0.26|0.58,0.68,0.50|64|28|38|Threat|0.08|0.03|Musical low panic cue with restrained instability
'@
...
$startSlot = if ($Bank -eq "BoC") { 128 } else { 64 }
$endSlot = $startSlot + 63
$slot = $startSlot
...
if (($specs.Count -ne 64) -or ($slot -ne ($endSlot + 1))) {
    throw "The curated bank must contain exactly 64 patches in slots $startSlot..$endSlot."
}
if ($Bank -eq "BoC") {
    $expected = @{
        "Pad"=10; "Lead"=8; "Bass"=8; "Pluck"=6; "Bell"=6
        "Texture"=8; "Experimental"=4
    }
    foreach ($entry in $expected.GetEnumerator()) {
        if (@($specs | Where-Object Category -eq $entry.Key).Count -ne $entry.Value) {
            throw "BoC category $($entry.Key) does not match its requested count."
        }
    }
    if (@($specs | Where-Object { $_.Category -in @("Keys","Organ","Strings") }).Count -ne 14) {
        throw "BoC keys/organs/strings count must be 14."
    }
}
...
function Get-Envelope([string]$Category) {
    switch ($Category) {
        ...
        "Organ"        { return @(8,54,92,58,  8,48,108,54,  8,58,84,60) }
        "Strings"      { return @(18,68,78,72,  24,62,94,76,  14,72,70,82) }
...
function Get-PitchDest([string]$Engine) {
    switch ($Engine) {
        "Prism" { return $Param.PARAM_PRISM_COARSE }
        "Stack" { return $Param.PARAM_STACK_OSC1_TUNE }
        "Deluge" { return $Param.PARAM_DELUGE_TUNE }
    }
}
function Get-Modulation([object]$Spec) {
    $toneDest = Get-PrimaryToneDests $Spec.Engine
    $pitchDest = Get-PitchDest $Spec.Engine
    ...
    switch ($Spec.Mod) {
        ...
        "Stable"  { $lfo=@(@(4.7,0,1,0),@(0.041,1,0,90),@(0.12,5,0,180)); $env3=@(6,54,58,48); $routes.Add(@(1,$pitchDest,0.18)); $routes.Add(@(2,$Param.PARAM_FILTER_CUTOFF,3)); $routes.Add(@(3,$toneDest[0],3)) }
        "Tape"    { $lfo=@(@(0.071,4,0,0),@(0.46,0,0,90),@(0.029,1,0,180)); $env3=@(12,70,62,76); $routes.Add(@(1,$pitchDest,0.42)); $routes.Add(@(2,$pitchDest,0.16)); $routes.Add(@(3,$Param.PARAM_FILTER_CUTOFF,5)); $routes.Add(@(6,$toneDest[1],5)); $routes.Add(@(1,$Param.PARAM_MIX_LEVEL,2)) }
        "Faded"   { $lfo=@(@(0.047,4,0,0),@(0.083,0,0,90),@(0.19,5,0,180)); $env3=@(18,76,52,84); $routes.Add(@(1,$Param.PARAM_FILTER_CUTOFF,7)); $routes.Add(@(2,$toneDest[0],5)); $routes.Add(@(3,$Param.PARAM_MIX_LEVEL,2)); $routes.Add(@(6,$toneDest[1],5)) }
        "Fragile" { $lfo=@(@(0.063,4,0,0),@(0.39,0,0,90),@(0.11,5,0,180)); $env3=@(20,82,42,92); $routes.Add(@(1,$pitchDest,0.30)); $routes.Add(@(2,$pitchDest,0.12)); $routes.Add(@(3,$toneDest[0],6)); $routes.Add(@(6,$Param.PARAM_FILTER_CUTOFF,8)); $routes.Add(@(1,$Param.PARAM_MIX_PAN,3)) }
        "Naive"   { $lfo=@(@(4.9,0,1,0),@(0.09,1,0,90),@(0.23,5,1,180)); $env3=@(1,42,18,36); $routes.Add(@(1,$pitchDest,0.24)); $routes.Add(@(2,$toneDest[0],4)); $routes.Add(@(3,$Param.PARAM_MIX_PAN,3)); $routes.Add(@(6,$Param.PARAM_FILTER_CUTOFF,6)) }
        "Threat"  { $lfo=@(@(0.083,4,0,0),@(0.31,0,0,90),@(0.041,8,0,180)); $env3=@(8,62,48,70); $routes.Add(@(1,$pitchDest,0.48)); $routes.Add(@(2,$toneDest[0],8)); $routes.Add(@(3,$Param.PARAM_FILTER_CUTOFF,7)); $routes.Add(@(6,$toneDest[1],9)) }
        "Flute"   { $lfo=@(@(5.1,0,1,0),@(0.071,1,0,90),@(0.17,5,1,180)); $env3=@(18,62,104,52); $routes.Add(@(7,$pitchDest,0.34)); $routes.Add(@(2,$Param.PARAM_FILTER_CUTOFF,4)); $routes.Add(@(3,$toneDest[0],4)); $routes.Add(@(6,$Param.PARAM_MIX_LEVEL,2)) }
        "Unstable"{ $lfo=@(@(0.13,4,1,0),@(0.63,0,0,90),@(0.047,8,0,180)); $env3=@(4,56,36,64); $routes.Add(@(1,$pitchDest,0.95)); $routes.Add(@(2,$pitchDest,0.38)); $routes.Add(@(3,$toneDest[0],12)); $routes.Add(@(6,$Param.PARAM_FILTER_CUTOFF,11)); $routes.Add(@(1,$Param.PARAM_MIX_PAN,5)) }
...
function New-Payload([object]$Spec) {
    ...
    Set-U8 $payload ($sound + 156) 1
    Set-U8 $payload ($sound + 157) $(if ($Spec.Mod -eq "Flute") { 6 } else { 2 })
    ...
    if ($Spec.Engine -eq "Prism") {
        ...
        if ($Spec.Mod -eq "Dust") { Set-F32 $toneBytes 308 0.06 }
    } else {
...
$categoryOrder = if ($Bank -eq "BoC") {
    @("Keys","Organ","Strings","Pad","Lead","Bass","Pluck","Bell","Texture","Experimental")
} else {
    @("Pad","Pluck","Lead","Bass","Keys","Bell","Texture","Experimental")
}
$readme = New-Object Text.StringBuilder
$readmeTitle = if ($Bank -eq "BoC") { "# BRICK6 BoC-Inspired Patch Bank" } else { "# BRICK6 Musical Patch Bank" }
[void]$readme.AppendLine($readmeTitle)
[void]$readme.AppendLine()
[void]$readme.AppendLine("64 original mono-track P1 patches for slots $startSlot-$endSlot. Copy the `BRICK` directory to the SD-card root.")
[void]$readme.AppendLine()
...
$regenCommand = 'powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\tools\patch_bank\generate_musical_patch_bank.ps1'
if ($Bank -eq "BoC") { $regenCommand += ' -Bank BoC' }
[void]$readme.AppendLine($regenCommand)
[void]$readme.AppendLine('```')
[IO.File]::WriteAllText((Join-Path $OutputRoot "README.md"), $readme.ToString(), [Text.UTF8Encoding]::new($false))
$generatorCopyName = if ($Bank -eq "BoC") { "generate_boc_inspired_patch_bank.ps1" } else { "generate_musical_patch_bank.ps1" }
Copy-Item -LiteralPath (Join-Path $RepoRoot "tools\patch_bank\generate_musical_patch_bank.ps1") -Destination (Join-Path $OutputRoot $generatorCopyName)
...
$categoryCounts = if ($Bank -eq "BoC") {
    $keys = @($manifest | Where-Object { $_.Category -in @("Keys","Organ","Strings") }).Count
    @("Keys/Organs/Strings=$keys",
      "Pad=$(@($manifest | Where-Object Category -eq 'Pad').Count)",
      "Lead=$(@($manifest | Where-Object Category -eq 'Lead').Count)",
      "Bass=$(@($manifest | Where-Object Category -eq 'Bass').Count)",
      "Pluck=$(@($manifest | Where-Object Category -eq 'Pluck').Count)",
      "Bell/Mallet=$(@($manifest | Where-Object Category -eq 'Bell').Count)",
      "Drone/Texture=$(@($manifest | Where-Object Category -eq 'Texture').Count)",
      "Experimental=$(@($manifest | Where-Object Category -eq 'Experimental').Count)")
} else {
...
Write-Output "SLOTS=$startSlot-$endSlot"
