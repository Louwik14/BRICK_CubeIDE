...
| Remapping storage | Pattern et Project construisent une bijection bornée `role + ordinal`; config, sound, mix, séquences/actions, routes, globals trackés, Note FX, Multi et locks Macro sont normalisés avant application. Identité absente ou dupliquée : refus sans mutation. | Conforme |
