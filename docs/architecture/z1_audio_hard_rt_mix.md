...
- Les fenetres temporelles conservent les marges precedentes: Classic forward = 12 petites pages total (`current + 11`), Classic reverse = 8 petites pages total (`current + 7`), Multi = 28 petites pages total (`current + 27`).
