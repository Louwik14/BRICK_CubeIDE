...
#define SAMPLE_CAPTURE_DETAIL_BUILD_CHUNK_FRAMES 682U
#define SAMPLE_CAPTURE_DETAIL_CACHE_MARGIN_MULT 1U
#define SAMPLE_CAPTURE_LINE_MAX_SOURCE_FRAMES 682U
#define SAMPLE_CAPTURE_LINE_MIN_VISIBLE_FRAMES SAMPLE_CAPTURE_LINE_POINTS
#define SAMPLE_CAPTURE_LINE_BUILD_CHUNK_FRAMES 682U
...
#define SAMPLE_CAPTURE_EDITOR_TILE_BUILD_CHUNK_FRAMES 682U
...
#define SAMPLE_CAPTURE_GLOBAL_OVERVIEW_BUILD_CHUNK_FRAMES 682U
