...
uint8_t project_product_load(uint8_t slot)
{
    ...
    if(ok)ok=(persistent_pattern_control_install_restored(&restore->working_pattern,0U)==PERSIST_CODEC_OK)?1U:0U;
