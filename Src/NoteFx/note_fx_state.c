...
void note_fx_chain_state_make_default(note_fx_chain_state_t *out_state)
{
    ...
    *out_state = (note_fx_chain_state_t){
        .generator = {
            .p1 = 0U,
            .p2 = SEQ_DIVISION_ARP_DEFAULT_INDEX,
            .p3 = 1U,
            .mode = NOTE_FX_GENERATOR_OFF
        },
        .voicer = {
            .type = 0U,
            .spread = NOTE_FX_VOICER_SPREAD_CLOSED,
            .invert = NOTE_FX_VOICER_INVERT_ROOT,
            .mode = NOTE_FX_VOICER_MODE_OFF
        },
        .scaler = {
            .key = 0U,
            .stick = NOTE_FX_SCALER_STICK_FIXED_DOWN,
            .transpose = 12U,
            .scale = NOTE_FX_SCALER_SCALE_OFF
        },
        .trig = {
            .lot = NOTE_FX_TRIG_LOT_GROUP,
            .keep = NOTE_FX_TRIG_KEEP_OFF,
            .gate = 100U,
            .chance = NOTE_FX_TRIG_CHANCE_OFF
        }
    };
}
    ...
    note_fx_chain_state_t *out_effective)
{
    ...
    effective.scaler.transpose = note_fx_chain_clamp(
        effective.scaler.transpose, 0U, 24U);
    ...
    effective.trig.chance = note_fx_chain_clamp(
        effective.trig.chance, NOTE_FX_TRIG_CHANCE_OFF,
        NOTE_FX_TRIG_CHANCE_0);
