 ...
 * Role: Persistance SD du projet s̩quenceur (format binaire versionn̩).
 * Responsibilities: mount/IO fichier, en-t̻te magic/version, CRC16,
 * chargement/sauvegarde atomiques de l'̩tat expos̩ par seq_model.
 * Integration: fronti̬re stockage du s̩quenceur; ne contient aucune logique d'̩dition/playback.
 */
