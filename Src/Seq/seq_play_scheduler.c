                                                ...
                                                uint8_t is_note_on)
{
    ...
    else if (resolved.descriptor.engine == TRACK_RUNTIME_ENGINE_PLAITS)
    {
        if (is_note_on != 0U)
        {
            brick6_plaits_runtime_note_on(resolved.descriptor.instance_id, (float)note, (float)velocity / 127.0f);
        }
        else
        {
