...
static const char *const g_macro_fx_type_labels[] = {"OFF", "DRIVE", "CRUSH", "PUMP", "CHOP", "WOBBLE", "COMB", "RING", "STUTTER", "FREEZE", "COLOR", "CHORUS_MICRO", "CHORUS_DAISY", "CHORUS_JUNO", NULL};
...
const param_desc_t param_registry[PARAM_COUNT] = {
    ...
    PARAM_DESC_EX(PARAM_MIX_REVERB_SPECTRAL_POSITION, "POSITION", PARAM_TYPE_FLOAT, 0.0f, 1.0f, 0.01f, 0.5f, PARAM_DISPLAY_PERCENT, "", NULL, apply_mix_reverb_spectral_position),
    PARAM_DESC_EX(PARAM_MIX_REVERB_SPECTRAL_WIDTH, "WIDTH", PARAM_TYPE_FLOAT, 0.0f, 1.0f, 0.01f, 1.0f, PARAM_DISPLAY_PERCENT, "", NULL, apply_mix_reverb_spectral_width),
    ...
    PARAM_DESC_EX(PARAM_MACRO_FX1_TYPE, "MODEL", PARAM_TYPE_ENUM, 0.0f, 13.0f, 1.0f, 0.0f, PARAM_DISPLAY_ENUM, "", g_macro_fx_type_labels, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX1_LEVEL, "LVL", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 80.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX1_A, "DEPTH", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 82.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX1_B, "RATE", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 45.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX2_TYPE, "FX2", PARAM_TYPE_ENUM, 0.0f, 10.0f, 1.0f, 0.0f, PARAM_DISPLAY_ENUM, "", g_macro_fx_type_labels, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX2_LEVEL, "LVL", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 0.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX2_A, "A", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 0.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX2_B, "B", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 0.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX3_TYPE, "FX3", PARAM_TYPE_ENUM, 0.0f, 10.0f, 1.0f, 0.0f, PARAM_DISPLAY_ENUM, "", g_macro_fx_type_labels, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX3_LEVEL, "LVL", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 0.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX3_A, "A", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 0.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX3_B, "B", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 0.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX4_TYPE, "FX4", PARAM_TYPE_ENUM, 0.0f, 10.0f, 1.0f, 0.0f, PARAM_DISPLAY_ENUM, "", g_macro_fx_type_labels, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX4_LEVEL, "LVL", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 0.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX4_A, "A", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 0.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
    PARAM_DESC_EX(PARAM_MACRO_FX4_B, "B", PARAM_TYPE_INT, 0.0f, 127.0f, 1.0f, 0.0f, PARAM_DISPLAY_INT, "", NULL, NULL),
